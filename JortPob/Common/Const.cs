...
namespace JortPob.Common
{
    public static class Const
    {
        ...
        public static readonly bool DEBUG_DONT_WRITE_BLANK_MSBS = true; // if true we don't overwrite base game overworld tiles with blanks. probably no reason to set this to true but it's here
        ...
        public static readonly bool DEBUG_SKIP_ESD = true; // skip building dialog esd for npcs, can be slow
        ...
        public static bool DEBUG_EXCLUSIVE_INTERIOR_BUILD_NAME(string name)
        {
            ...
            string[] MATCHES = null; // new[] { "Seyda Neen" };
